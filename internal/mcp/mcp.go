	...
	return []toolDef{
		...
		// --- Tickets (tasks within a project) ---
		{
			...
			InputSchema: jsonSchema{
				...
				Properties: map[string]schemaProp{
					...
					"status":    {Type: "string", Description: "Filter by status", Enum: []string{"todo", "in_progress", "dev_done", "qa_in_progress", "live_in_progress", "done"}},
		...
		},
		{
			...
			InputSchema: jsonSchema{
				...
				Properties: map[string]schemaProp{
					...
					"status":      {Type: "string", Description: "Initial status", Enum: []string{"todo", "in_progress", "dev_done", "qa_in_progress", "live_in_progress", "done"}},
		...
		},
		{
			...
			InputSchema: jsonSchema{
				...
				Properties: map[string]schemaProp{
					...
					"status":      {Type: "string", Description: "Status", Enum: []string{"todo", "in_progress", "dev_done", "qa_in_progress", "live_in_progress", "done"}},
		...
		},
		{
			...
			InputSchema: jsonSchema{
				...
				Properties: map[string]schemaProp{
					"id":     {Type: "string", Description: "Ticket ID"},
					"status": {Type: "string", Description: "Target status", Enum: []string{"todo", "in_progress", "dev_done", "qa_in_progress", "live_in_progress", "done"}},
				},
		...
		{
			Name:        "get_board",
			Description: "Get full Kanban board grouped by status columns (todo, in_progress, dev_done, qa_in_progress, live_in_progress, done)",
			InputSchema: jsonSchema{
				Type: "object",
				Properties: map[string]schemaProp{
